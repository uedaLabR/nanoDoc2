...
if __name__ == '__main__':
    ...
    out = "/data/nanopore/nanoDoc2_1/varidate/18S_score.txt"
    ...
    with tf.device('/CPU:0'):
        ...
        comparisonAnalysisKmean.modCall(wfile, ref, refpq, targetpq, out, chrom, chromtgt, start, end, minreadlen, uplimit=500)
