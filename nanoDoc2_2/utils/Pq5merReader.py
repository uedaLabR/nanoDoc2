...
class PqReader:
    ...
    def load(self,chr, pos, strand):
        ...
        dataWithRow['signalboundary'] = dataWithRow['signalboundary'] .apply(intervalToAbsolute)
    ...
    def getRowData(self, chr, strand, pos,takecnt=-1):
        ...
        return signals,traces,sampledlen,infos
    ...
    def calcStartEnd(self,strand,start,end,cigar,pos):

        rp = self.getRelativePos(strand,start,end,cigar,pos)
    ...
    def getOneRow(self,row,strand, pos,rseq):
        ...
        if (signalend-signalstart) < 50:
            return None

        signal_t = signal[signalstart:signalend]
        print(signalstart,signalend,signalend-signalstart)
        tracestart = signalstart // 10
        ...
        binsignal = ret
        return binsignal,bintrace,info
    ...
    def getFormattedData(self, strand, pos,rseq,_takecnt):
        ...
        return  signals,traces,takecnt,infos
